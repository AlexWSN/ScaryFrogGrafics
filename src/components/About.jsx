  ...
  return (
    <section
      ...
      <div className="flex flex-col items-center">
        ...
        {/* Icon Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-14 w-full px-4">
          {[
            {
              img: "arrows.png",
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex flex-col text-3xl md:text-4xl font-bold tracking-wide font-teko leading-tight">
            <span className="text-orange-500">Let’s</span>
            <span className="text-orange-500">build</span>
            <span className="text-orange-500">bridges,</span>
